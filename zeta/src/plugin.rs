...
mod prelude {
    ...
    pub use zeta_plugin::prelude::{
        ...
        REPLY_PREFIX, RESET, RawEvent, Sender, Subscriptions, UrlEvent, UrlScope, em, field,
        notice, parse_args_or_usage, parse_words_or_usage, plugin_err, quoted, reply,
        reply_first_lookup, reply_lookup, reply_prefix, reply_usage_lines, resolve_secret,
    };
